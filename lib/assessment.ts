...
export const DEMO_ASSESSMENTS: FacilityAssessment[] = [
  createDemoAssessment({
    ...
    county: "Embu",
    subCounty: "Embu west Sub County",
    date: "2026-08-01",
    assessmentType: "baseline",
  ...
  createDemoAssessment({
    ...
    county: "Embu",
    subCounty: "Runyenjes Sub County",
    date: "2026-08-01",
    assessmentType: "baseline",
    assessorName: "Demo Assessor",
    responses: {
  ...
  createDemoAssessment({
    ...
    facilityLevel: "Level 5",
    county: "Meru",
    subCounty: "Imenti Central Sub County",
    date: "2026-08-02",
  ...
  createDemoAssessment({
    ...
    facilityLevel: "Level 3",
    county: "Meru",
    subCounty: "Imenti South Sub County",
    date: "2026-08-02",
    assessmentType: "quarterly",
    assessorName: "Demo Assessor",
    responses: {
